...
import defaultAvatar from "../../assets/avatar/blank-profile-picture-973460_960_720.webp";
...
export const UserInfo: React.FC<UserInfoProps> = ({ menuRef, status, open }) => {
    ...
    >
        <UserAvatar src={session?.details?.immagini?.avatar} name={session?.details?.nome} cognome={session?.details?.cognome} />
