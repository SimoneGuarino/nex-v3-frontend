...
export function UploadAPI({ userContext, abortController, body, setErr, ChangeLoadStatus, successOperation }: {
    ...
    FetchFileData(`${import.meta.env.VITE_API_PDF_READER}brd/et-bd-fls`, "POST", body, abortController)
        .then((res: any) => {
