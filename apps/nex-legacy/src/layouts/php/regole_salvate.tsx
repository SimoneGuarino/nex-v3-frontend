...
const RegoleSalvate: React.FC<{}> = () => {
    ...
    // Vari/MetodiPagamento.php
        const url = import.meta.env.VITE_API_MARIA_MACHINE + "Correlati/salva_corelazione.php?readonly=true";
    ...
    return (
        <DashboardLayout>
            {/* Iframe con name="correlatiFrame" */}
            <iframe
                name="correlatiFrame"
