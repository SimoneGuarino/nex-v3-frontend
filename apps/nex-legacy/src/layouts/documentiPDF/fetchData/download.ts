...
export async function DownloadFilesAPI({ abortController, query, HandleError, ChangeLoadStatus }: DataAPIProps) {
    return await FetchData(`${import.meta.env.VITE_API_PDF_READER}pdf/v2/download?${query}`, 'GET', null, abortController)
