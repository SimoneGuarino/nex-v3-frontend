...
export { BufferToData } from './BuffertToData.ts';
export { StringAvatar } from './stringToColor.ts';
export { PickLowest } from './PickLowest.ts';
export { NumberToEuro } from './numberToEuro.ts';
export { RetriveCookie, SaveCookie } from './cookie.ts';
export { CheckAdminPermissions } from './checkAdminPermissions.ts'
export { GetDate } from './date/getDate.ts';
